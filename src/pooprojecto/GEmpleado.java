...
public class GEmpleado extends javax.swing.JFrame {
    ...
    public void actualizarTabla(){
        ...
        if (TablaU.getColumnModel().getColumnCount() > 7) {
            TableColumn col = TablaU.getColumnModel().getColumn(7);
            col.setMinWidth(0);
            col.setMaxWidth(0);
    ...
    private void initComponents() {
        ...
        TablaU.setForeground(new java.awt.Color(0, 102, 153));
        TablaU.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombres", "Apellidos", "Correo", "DNI", "Telefono", "Especialidad", "Rol", "Title 8"
            }
        ));
        jScrollPane1.setViewportView(TablaU);

        jPanel1.add(jScrollPane1);
        jScrollPane1.setBounds(30, 80, 740, 370);
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(310, 20, 190, 48);
    ...
    private void EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        ...
        Usuario usuario = (Usuario) TablaU.getValueAt(fila, 7);
        boolean eliminado = Sistema.gestionUsuarios.EliminarUsuario(usuario);
        if(eliminado){
            actualizarTabla();
            int total = Sistema.gestionUsuarios.getNroUsuarios();
            JOptionPane.showMessageDialog(this, "Usuario eliminado correctamente.\nUsuarios restantes en el sistema: " + total);
        } else {
    ...
    private void ModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ModificarActionPerformed
        ...
        RegistrarE r = new RegistrarE(this, usuario);  
        r.setVisible(true);
        r.pack();
        r.setLocationRelativeTo(null);
        return;
